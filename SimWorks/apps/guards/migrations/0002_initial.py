...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="sessionpresence",
            index=models.Index(
                fields=["lab_type", "guard_state"], name="idx_guard_lab_state"
            ),
        ),
        migrations.AddIndex(
            model_name="sessionpresence",
            index=models.Index(
                fields=["engine_runnable"], name="idx_guard_engine_runnable"
            ),
        ),
        migrations.AddIndex(
            model_name="usagerecord",
            index=models.Index(
                fields=["scope_type", "simulation_id"], name="idx_usage_scope_sim"
            ),
        ),
        migrations.AddIndex(
            model_name="usagerecord",
        ...
        migrations.AddIndex(
            model_name="usagerecord",
            index=models.Index(
                fields=["lab_type", "product_code"], name="idx_usage_lab_product"
            ),
        ),
