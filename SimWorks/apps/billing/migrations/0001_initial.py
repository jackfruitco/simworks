...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope_type",
                    models.CharField(
                        choices=[("account", "Account"), ("user", "User")],
                        max_length=20,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="idx_webhook_provider_status",
                    ),
                    models.Index(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account", "provider_type"], name="idx_billing_account_provider"
            ),
        ),
        migrations.AddIndex(
            model_name="billingaccount",
            index=models.Index(
                fields=["billing_email"], name="idx_billing_account_email"
            ),
        ),
        migrations.AddConstraint(
            model_name="billingaccount",
            constraint=models.UniqueConstraint(
                condition=models.Q(("provider_customer_id__gt", "")),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account", "status", "product_code"],
                name="idx_entitlement_product",
            ),
        ),
        migrations.AddIndex(
            model_name="entitlement",
        ...
        migrations.AddIndex(
            model_name="entitlement",
            index=models.Index(
                fields=["source_type", "source_ref"], name="idx_entitlement_source"
            ),
        ),
        migrations.AddConstraint(
            model_name="entitlement",
            constraint=models.UniqueConstraint(
                condition=models.Q(("subject_user__isnull", True)),
                fields=(
                    "account",
                    "source_type",
                    "source_ref",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account", "product_code"], name="idx_seat_allocation_product"
            ),
        ),
        migrations.AddIndex(
            model_name="seatassignment",
            index=models.Index(
                fields=["account", "product_code"], name="idx_seat_assignment_product"
            ),
        ),
        migrations.AddIndex(
            model_name="seatassignment",
            index=models.Index(
                fields=["user", "product_code"], name="idx_seat_assignment_user"
            ),
        ),
        migrations.AddConstraint(
            model_name="seatassignment",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account", "status"], name="idx_sub_account_status"
            ),
        ),
        migrations.AddIndex(
            model_name="subscription",
            index=models.Index(
                fields=["plan_code", "status"], name="idx_subscription_plan_status"
            ),
        ),
        migrations.AddConstraint(
            model_name="subscription",
            constraint=models.UniqueConstraint(
                condition=models.Q(("provider_subscription_id__gt", "")),
        ...
        migrations.AddConstraint(
            model_name="subscription",
            constraint=models.UniqueConstraint(
                condition=models.Q(("provider_original_transaction_id__gt", "")),
