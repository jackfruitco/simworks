...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="superseded_by",
                        to="trainerlab.patientstatusstate",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Optional parent problem for derived/systemic progression while preserving the direct cause relationship.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="superseded_by",
                        to="trainerlab.diagnosticresult",
                    ),
                ),
                (
                    "target_problem",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="superseded_by",
                        to="trainerlab.assessmentfinding",
                    ),
                ),
                (
                    "target_problem",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="superseded_by",
                        to="trainerlab.recommendedintervention",
                    ),
                ),
                (
                    "target_illness",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="orchestrai_django.servicecall",
                    ),
                ),
                (
                    "session",
            ...
            options={
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            (
                                "min_value_diastolic__lte",
                                models.F("max_value_diastolic"),
                            )
                        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="superseded_by",
                        to="trainerlab.dispositionstate",
                    ),
                ),
            ],
            options={
                "indexes": [
                    models.Index(
                        fields=["simulation", "status"], name="idx_dispo_sim_status"
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="problem",
            index=models.Index(
                fields=["simulation", "status"], name="idx_problem_sim_status"
            ),
        ),
        migrations.AddIndex(
            model_name="problem",
            index=models.Index(
                fields=["simulation", "kind"], name="idx_problem_sim_kind"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["simulation", "kind"], name="idx_finding_sim_kind"
            ),
        ),
        migrations.AddIndex(
            model_name="assessmentfinding",
        ...
        migrations.AddIndex(
            model_name="recommendedintervention",
            index=models.Index(
                fields=["target_problem"], name="idx_reco_target_problem"
            ),
        ),
        migrations.AddIndex(
            model_name="recommendationevaluation",
            index=models.Index(
                fields=["simulation", "validation_status"], name="idx_reval_sim_status"
            ),
        ),
        migrations.AddIndex(
            model_name="recommendationevaluation",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["simulation", "code"], name="idx_resource_sim_code"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["command_type", "issued_at"], name="idx_trainer_claim_type"
            ),
        ),
        migrations.AddIndex(
            model_name="traineridempotencyclaim",
            index=models.Index(
                fields=["session", "issued_at"], name="idx_trainer_claim_session"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["session", "created_at"], name="idx_tl_agent_vm_session"
            ),
        ),
        migrations.AddIndex(
            model_name="traineragentviewmodelrecord",
            index=models.Index(
                fields=["session", "state_revision"], name="idx_tl_agent_vm_revision"
            ),
        ),
        migrations.AddIndex(
            model_name="traineragentviewmodelrecord",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["simulation", "created_at"], name="idx_runtime_evt_sim"
            ),
        ),
        migrations.AddIndex(
            model_name="runtimeevent",
            index=models.Index(
                fields=["session", "created_at"], name="idx_runtime_evt_session"
            ),
        ),
        migrations.AddIndex(
