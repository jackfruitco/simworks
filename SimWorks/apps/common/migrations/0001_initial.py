        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, db_index=True, help_text="When the event was created"
                    ),
                ),
                (
                    "delivered_at",
                ...
                (
                    "delivery_attempts",
                    models.PositiveIntegerField(default=0, help_text="Number of delivery attempts"),
                ),
                (
                    "last_error",
                    models.TextField(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["simulation_id", "created_at"], name="outbox_sim_created_idx"
                    ),
                    models.Index(
