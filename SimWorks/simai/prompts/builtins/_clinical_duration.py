...
@register_modifier("ClinicalDuration.Acute", "prefer acute scenario")
...
@register_modifier("ClinicalDuration.SubAcute", "prefer sub-acute scenario")
...
@register_modifier("ClinicalDuration.Chronic", "prefer chronic scenario")
