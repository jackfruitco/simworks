...
def clinical_scenario_msk(user=None, role=None):
...
def clinical_scenario_resp(user=None, role=None):
...
def clinical_scenario_virus(user=None, role=None):
...
def clinical_scenario_bact(user=None, role=None):
