...
from simcore_ai.services import BaseLLMService, llm_service
...
class GeneratePatientInitial(BaseLLMService):
...
@llm_service(origin="chatlab", bucket="patient")
class GeneratePatientReply(BaseLLMService):
...
@llm_service(origin="chatlab", bucket="patient")
class GeneratePatientImage(BaseLLMService):
