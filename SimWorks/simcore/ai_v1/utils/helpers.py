...
try:
    from simcore.ai_v1.dtos import LLMRequest, MessageItem  # preferred path
except Exception:
    try:
        from simcore.ai_v1.types import LLMRequest, MessageItem  # fallback path
    except Exception:
...
def maybe_coerce_to_schema(
    ...
    warnings.warn(
        ...
        "use simcore.ai_v1.parsers.output_parser instead",
        DeprecationWarning
    )
