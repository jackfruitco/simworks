# simcore/ai_v1/utils/imports.py
...
def resolve_initial_section(lab: str):
    ...
    DEFAULT_PATHS: list[str] = [
        f"{app_config.name}.ai.prompts",                       # e.g. app/ai_v1/prompts.py
        f"{app_config.name}.ai.prompts.sections",              # e.g. app/ai_v1/prompts/sections.py
        f"{app_config.name}.ai.prompts.sections.initial",      # e.g. app/ai_v1/prompts/sections/initial.py
    ]
