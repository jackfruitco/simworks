...
VOICELAB_BOOTSTRAP_MAX_TOKENS = int_from_env(
    "VOICELAB_BOOTSTRAP_MAX_TOKENS",
    default=6000,
    minimum=256,
)
OPENAI_API_BASE_URL = os.getenv("OPENAI_API_BASE_URL", "https://api.openai.com/v1")
OPENAI_CONVERSATION_TIMEOUT_SECONDS = float(os.getenv("OPENAI_CONVERSATION_TIMEOUT_SECONDS", "10"))
