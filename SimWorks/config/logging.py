...
The LOGGING dictionary configures formatters, handlers, and loggers for various parts of the application, ensuring that log messages are routed appropriately. The console handler output log messages to the standard output using a verbose format that includes the timestamp, log level, logger name, and line number.
