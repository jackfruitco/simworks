...
def control_plane_debug_to_out(session: TrainerSession) -> ControlPlaneDebugOut:
    ...
    return ControlPlaneDebugOut(
        ...
        queued_reasons=list(debug.get("queued_reasons") or runtime_state.get("pending_runtime_reasons") or []),
        ...
        last_processed_reasons=list(
            debug.get("last_processed_reasons") or runtime_state.get("last_processed_runtime_reasons") or []
        ),
        last_failed_step=str(debug.get("last_failed_step") or ""),
        last_failed_error=str(debug.get("last_failed_error") or runtime_state.get("last_runtime_error") or ""),
