# orchestrai_django/types/django_dtos.py
"""
Django-specific rich Data Transfer Objects (DTOs).

These classes extend the core `orchestrai.types` models with optional Django-facing metadata:
...
- backend/client metadata for observability
