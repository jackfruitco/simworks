# packages/orchestrai_django/src/orchestrai_django/api/decorators.py
...
Django layer so app code can import them from a single, stable location:
    ...
    from orchestrai_django.api.decorators import ai_service, codec, prompt_section, schema
...
from orchestrai_django.decorators import *
