...
def emit_request(*, request_dto, namespace: Optional[str] = None, client_name: Optional[str] = None,
                 ...
                 request_audit_pk: Optional[int] = None, origin: Optional[str] = None,
                 bucket: Optional[str] = None, service_name: Optional[str] = None) -> None:
    payload = dict(
        request=request_dto,
...
def emit_response_received(*, response_dto, namespace: Optional[str] = None, client_name: Optional[str] = None,
                           ...
                           origin: Optional[str] = None, bucket: Optional[str] = None,
