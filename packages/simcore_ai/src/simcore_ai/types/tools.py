...
including provider-agnostic tool declarations at request time, normalized tool call records
...
class BaseLLMTool(StrictBaseModel):
    ...
    input_schema: dict[str, Any] = Field(default_factory=dict, description="JSON Schema for tool arguments; interpreted by provider codecs.")
