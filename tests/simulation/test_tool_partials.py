...
class TestToolPartials:
    ...
    def test_nonexistent_partial_raises_error(self):
        ...
        with pytest.raises(TemplateDoesNotExist):
            get_template("simulation/tools.html#tool_nonexistent")
